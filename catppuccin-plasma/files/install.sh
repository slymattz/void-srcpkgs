...
COLORDIR="${XDG_DATA_HOME:-$build_wrksrc/usr/share}/color-schemes"
AURORAEDIR="${XDG_DATA_HOME:-$build_wrksrc/usr/share}/aurorae/themes"
LOOKANDFEELDIR="${XDG_DATA_HOME:-$build_wrksrc/usr/share}/plasma/look-and-feel"

echo "Creating theme directories.."
mkdir -p "$COLORDIR" "$AURORAEDIR" "$LOOKANDFEELDIR"
mkdir ./dist
